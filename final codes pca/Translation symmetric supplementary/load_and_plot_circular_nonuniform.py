# -*- coding: utf-8 -*-
"""
Created on Tue Jun 20 21:42:27 2023
...
for d in d_list:
    fw=open('circular_multid_data/2023_06_19/linear_dim_data_nonuniform_tc_d={}'.format(d),'rb')
...
plt.savefig('plots/2023_06_20/linear_dim_vs_d_nonuniform_tc_backgorund_sigma=01')
plt.show()
plt.close()
...
plt.ylabel("Linear dim")
plt.title('Linear dim vs d, nonuniform tc, background sigma={}'.format(sigma))
plt.savefig('plots/2023_06_20/linear_dim_vs_d_nonuniform_tc_backgorund_sigma=01_bar')
plt.show()
plt.show()
plt.close()
...
plt.ylabel("Linear dim")
plt.title('Linear dim vs d, nonuniform tc, background sigma={}'.format(sigma))
plt.savefig('plots/2023_06_20/linear_dim_vs_d_nonuniform_tc_backgorund_sigma=02')
plt.show()
plt.close()
